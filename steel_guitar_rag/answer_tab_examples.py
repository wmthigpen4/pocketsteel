...
from steel_guitar_rag.tab_engine import default_e9_copedent_profile, render_example, tab_examples
from steel_guitar_rag.tab_engine import render_tab, TabEvent, TabNote
        ...
        "sourceContext": [
            {
                ...
                "sourceId": "steel_guitar_rag.answer_tab_examples",
            }
        ],
    }
        ...
        "sourceContext": [
            {
                ...
                "sourceId": "steel_guitar_rag.answer_tab_examples.static_grip",
            }
        ],
    }
    validate_fretboard_payload(payload)
