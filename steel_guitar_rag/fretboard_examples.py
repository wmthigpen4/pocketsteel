...
from steel_guitar_rag.fretboard_contracts import (
    AB_MAJOR_OFFSET,
    AF_MAJOR_OFFSET,
...
from steel_guitar_rag.music_text import normalize_accidental_symbols, normalize_spelled_accidentals
from steel_guitar_rag.user_copedent import USER_E9_COPEDENT, apply_changes, supports_standard_major_position_changes
            ...
            "sourceContext": [
                {
                    ...
                    "sourceId": "steel_guitar_rag.fretboard_examples",
                }
            ],
        }
