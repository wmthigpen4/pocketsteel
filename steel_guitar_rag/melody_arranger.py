...
from steel_guitar_rag.answer_tab_examples import fretboard_payload_for_tab_example
...
from steel_guitar_rag.fretboard_explorer import ExplorerRow, major_three_string_rows, major_two_string_rows
from steel_guitar_rag.melody_models import (
...
from steel_guitar_rag.melody_decision_rules import (
    MODEL_STATUS,
    MODEL_VERSION,
...
def _fretboard_payload_for_target_profile(
    ...
    return {
        ...
        "warnings": [],
        "sourceContext": [
            {"kind": "rule", "label": "Target copedent realization", "sourceId": "steel_guitar_rag.copedent_transfer"}
        ],
    }
