...
from steel_guitar_rag.api_contract import AnswerMode, SourceCitation
from steel_guitar_rag.rag_guardrails import safe_http_url

from steel_guitar_rag.basic_chord_answers import basic_chord_theory_answer_for_question, chord_change_answer_for_question
from steel_guitar_rag.curated_source_registry import answer_contains_unapproved_url, is_approved_curated_url, slide_bar_vendor_bullets
...
from steel_guitar_rag.user_copedent import (
...
def fallback_answer_for_category(category: FallbackCategory, question: str) -> str:
    ...
    if category == "song_source_needed":
        return (
            "Steel Guitar RAG can teach the song, artist solo, or arrangement on E9 and divide longer material into numbered sections. "
        ...
        messages = [
            {
                "role": "system",
                "content": (
                    "You are Steel Guitar RAG, a source-backed pedal steel guitar assistant. "
