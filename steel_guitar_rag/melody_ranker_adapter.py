...
Studio ranks :class:`~steel_guitar_rag.melody_models.PositionCandidate` objects.
...
from steel_guitar_rag.e9_copedents import E9CopedentProfile
from steel_guitar_rag.melody_models import PositionCandidate
from steel_guitar_rag.melody_ranker import FEATURE_NAMES, feature_vector
