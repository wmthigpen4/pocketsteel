...
from steel_guitar_rag.copedent_transfer import absolute_pitch_for_profile, resolve_control, transfer_controls
from steel_guitar_rag.e9_copedents import DEFAULT_COPEDENT_ID, E9CopedentProfile, get_e9_copedent_profile

from steel_guitar_rag.lesson_curriculum import (
    CURRICULUM_VERSION,
    catalog_paths,
