# ChatGPT Project Context Bundle
...
Do not upload large corpus dumps, raw source data, private lesson material, vector stores, Chroma databases, credentials, `.env` files, Cloudflare tokens, or generated private reports into ChatGPT Project files.

Recommended upload set:

- `01_Project_Charter.md`
- `02_Orchestrator_Playbook.md`
- `03_Lane_Map.md`
- `04_Codex_Prompt_Standards.md`
- `05_Current_Integration_Snapshot.md`
- `06_Tab_Engine_Product_Direction.md`
- `07_Source_And_Copyright_Guardrails.md`
- `08_Smoke_Test_Playbook.md`
