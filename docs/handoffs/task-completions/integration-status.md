...
- Protected-preview status for Explorer legitimate grip vocabulary: **not run in this Lane 05 implementation**. Protected preview needs Lane 12 restart/static verification at the direct cache-busted URL below before user smoke. This was not deployed or restarted as part of the backend/UI implementation commit.
