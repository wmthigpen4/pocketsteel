...
- Current HEAD after integration closeout: `ec42aa1 docs: record chord finder map view smoke`. This branch contains the required recent Explorer commits: `b55a12e feat: add shared explorer music rules boundary`, `dba7347 fix: improve explorer mobile control density`, `d988db7 fix: use structured chord finder controls`, and `c423e4b feat: map chord finder candidates on fretboard`.
