...
- Exact URL the user should use: protected-preview URL should be generated after commit/restart; local URL above was used for this lane
- Auth required: no
- Auth provider: none
...
Protected-preview smoke was not run in this lane.
...
- The protected-preview URL should use a fresh cache-bust based on the implementation commit hash.
...
```text
Lane 12: Run protected-preview smoke for the E9 Fretboard Explorer Voicing Identifier control polish using the committed cache-busted URL. Verify Voicing Identifier individual pedal/lever multi-select, string max-three behavior, F/3/4-6-10 A+B = C / V in F, odd 1-2-3 warning, no [object Object], and no console errors.
```
