# 2026-06-30 21:26 Lane 01 - Parameterized Movement User Smoke Closeout

## Pass / Warn / Fail

Pass.

User smoke passed for Parameterized Movement Cards v1.

## Task Summary

Requested:

- Record user-smoke pass for Parameterized Movement Cards v1.
...
- Expected git HEAD: `e449180` or later containing `254752a`
- Version endpoint: `/api/version`
- Version endpoint result: prior protected-smoke handoff reported `{"git_sha":"e449180","git_branch":"feature/answer-api","server_started_at":"2026-07-01T04:13:03.378070+00:00","python_module":"steel_guitar_rag.api","retrieval_mode":"hybrid_private_first","auth_provider":"cloudflare_access"}`
...
- G to C movement
- G to D movement
- `1 4 5 1` in G movement
- no-pedals to A+B movement
- static G grip stayed fretboard-first/no tab
- explicit `5-7-8` G stayed partial/color/no-3rd with no inert A+B
- Steel King settings regression

Recent protected-smoke commit:

- `ea796e4 docs: record parameterized movement protected smoke`

Runtime app-code behavior includes:

- `254752a feat: add parameterized e9 movement cards`

## Files Changed

- `docs/handoffs/task-completions/integration-status.md`
- `docs/handoffs/task-completions/2026-06-30-2126-01-parameterized-movement-user-smoke-closeout.md`
