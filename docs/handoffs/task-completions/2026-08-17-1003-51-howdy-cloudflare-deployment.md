...
- Companion revision: `howdy-transcribed-review-2026-08-17.15`
- Git SHA: `aa0dd3b6b1c1bd5fb203283d81bc39c98df12ab1`
- Deployment ID: `40207072-bd36-4640-a4f7-5b11e00ee62f`
- Immutable deployment URL: `https://40207072.steel-guitar-rag-travis-preview.pages.dev`
...
- Private release manifest: `tmp/howdy-owner-review-2026-08-17.34.release-manifest.json`
...
- The browser-loaded companion displays revision `.15`, build `aa0dd3b6b1c1`, a 100% playback default, the 3:57 full-song view, and working Chords/NNS chart switching.
...
- The printable taught solo is now one landscape letter page with no notation staff. It includes the official TTT logo, `travistoytutorials.com`, compact chord/key context, six tab-only phrase systems, and a restrained Steel Guitar RAG attribution. The rasterized page was inspected; bars 7-8, movement labels, and the footer remain inside the print-safe area without overlap or clipping.
...
- Anonymous requests to the immutable deployment alias `40207072.steel-guitar-rag-travis-preview.pages.dev` return the Access login redirect through the wildcard destination.
