...
assert.match(elements["explorer-active-results"].textContent, /Voicing/);
assert.match(elements["explorer-active-results"].textContent, /What gets dropped/);
assert.match(elements["explorer-active-results"].textContent, /Ambiguous/);
...
assert.match(elements["explorer-selected-detail"].textContent, /Voicing classificationComplete voicing/);
assert.match(elements["explorer-selected-detail"].textContent, /Defining tones/);
assert.match(elements["explorer-selected-detail"].textContent, /Safe omissions5th/);
assert.match(elements["explorer-selected-detail"].textContent, /What gets droppedNo chord tones dropped/);
assert.match(elements["explorer-selected-detail"].textContent, /When to play all strings/);
assert.match(elements["explorer-selected-detail"].textContent, /Strings \/ unique chord roles4 strings \/ 4 unique roles/);
...
elements["explorer-grip-vocabulary"].value = "extended";
elements["explorer-grip-vocabulary"].dispatchChange();
elements["explorer-chord-root"].value = "A";
elements["explorer-chord-root"].dispatchChange();
elements["explorer-chord-quality"].value = "major9";
elements["explorer-chord-quality"].dispatchChange();
assert.match(elements["explorer-chord-finder"].textContent, /true 9th voicing keeps the 7th and 9th/i);
const completeMaj9Card = elements["explorer-active-results"].querySelectorAll("[data-chord-finder-result]")
  .find((button) => button.rowId.includes(":4-5-6-7-9:7:A+B"));
assert.equal(Boolean(completeMaj9Card), true);
assert.match(elements["explorer-active-results"].textContent, /Amaj9/);
assert.match(elements["explorer-active-results"].textContent, /4-5-6-7-9/);
assert.match(elements["explorer-active-results"].textContent, /Extended five-note 9th grip/);
assert.match(elements["explorer-active-results"].textContent, /4-5-7-9/);
assert.match(elements["explorer-active-results"].textContent, /Practical voicing/);
assert.match(elements["explorer-active-results"].textContent, /4-5-7/);
assert.match(elements["explorer-active-results"].textContent, /Rootless ensemble voicing/);
