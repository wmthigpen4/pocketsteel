...
def test_same_origin_server_serves_ui_and_answer_client() -> None:
    ...
    assert b'<script src="melody-score.js?v=landing-melody-png-crop-20260714-1"></script>' in html
    assert b'<script src="landing-home.js?v=landing-bubble-labels-20260713"></script>' in html
    assert b'<link rel="stylesheet" href="workspace-shell.css?v=landing-melody-png-20260714-1">' in html
    ...
    assert b'<script src="melody-workbench.js?v=account-copedents-20260714-1"></script>' in studio
