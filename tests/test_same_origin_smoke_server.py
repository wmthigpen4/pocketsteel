...
def test_same_origin_server_serves_ui_and_answer_client() -> None:
    ...
    assert b'<script src="answer-client.js?v=copedent-library-v2-20260714-2"></script>' in html
    ...
    assert b'<script src="melody-workbench.js?v=copedent-library-v2-20260714-2"></script>' in studio
