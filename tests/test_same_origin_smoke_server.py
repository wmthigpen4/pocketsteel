...
def test_same_origin_server_serves_ui_and_answer_client() -> None:
    ...
    assert b'<link rel="stylesheet" href="workspace-shell.css?v=landing-score-fit-20260714-1">' in html
    ...
    assert b'<script src="melody-workbench.js?v=copedent-transfer-20260713-1"></script>' in studio
