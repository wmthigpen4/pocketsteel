...
def test_same_origin_server_serves_ui_and_answer_client() -> None:
    ...
    assert b'<script src="answer-client.js?v=progression-guide-v0-20260704"></script>' in html
    assert b'<script src="pedal-steel-fretboard.js?v=explorer-compare-fix-20260702b"></script>' in html
