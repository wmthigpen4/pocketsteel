...
def test_same_origin_server_serves_ui_and_answer_client() -> None:
    ...
    assert b'<script src="answer-client.js?v=router-fretboard-smoke-20260612"></script>' in html
    assert b'<script src="pedal-steel-fretboard.js?v=router-fretboard-smoke-20260612"></script>' in html
