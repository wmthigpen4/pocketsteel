...
def test_same_origin_server_serves_ui_and_answer_client() -> None:
    ...
    assert b'<script src="melody-score.js?v=portrait-print-20260713-1"></script>' in studio
    assert b'<script src="melody-workbench.js?v=portrait-print-20260713-1"></script>' in studio
