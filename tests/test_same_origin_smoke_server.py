...
def test_same_origin_server_serves_ui_and_answer_client() -> None:
    ...
    assert b'<script src="melody-score.js?v=melody-route-score-20260711-1"></script>' in studio
    assert b'<script src="melody-workbench.js?v=melody-result-layout-20260712-1"></script>' in studio
