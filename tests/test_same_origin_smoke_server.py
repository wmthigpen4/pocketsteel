...
def test_same_origin_server_serves_ui_and_answer_client() -> None:
    ...
    assert b'<script src="melody-score.js?v=full-grip-slides-20260713-1"></script>' in studio
    assert b'<script src="melody-workbench.js?v=full-grip-slides-20260713-1"></script>' in studio
