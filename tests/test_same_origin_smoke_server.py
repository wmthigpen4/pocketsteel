...
def test_same_origin_server_serves_ui_and_answer_client() -> None:
    ...
    assert b'<script src="melody-score.js?v=melody-score-practice-20260711-3"></script>' in studio
    assert b'<script src="melody-workbench.js?v=melody-active-marker-controls-20260711-1"></script>' in studio
